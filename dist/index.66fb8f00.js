...
function showModal() {
    ...
    if (modalContainer.hasChildNodes()) {
        /*Si el modal ya se agrego simplemente con retornamos no es necesario agregarlo de nuevo*/ console.log("Ya se agrego");
        return;
    }
    addDynamicHTML().then(()=>{
        startCamera();
    }).catch((error)=>{
        console.error("Error al agregar el HTML din\xe1micamente:", error);
    });
    /*Asignamos Eventos de toggle*/ const registerLink = document.querySelectorAll(".toggle-link");
...
/*Agregar eventos*/ /*Button to create and show the modal*/ /*
...
/*Camara Stuff*/ function startCamera() {
    ...
    function startStreaming() {
        ...
        if (mediaSupport && null == cameraStream) navigator.mediaDevices.getUserMedia({
            video: true,
            audio: false
    ...
    function captureSnapshot() {
        if (null != cameraStream) {
            ...
            /*img.width = 241;*/ /*img.height = 180;*/ snapshot.innerHTML = "";
...
//# sourceMappingURL=index.66fb8f00.js.map
