...
function addToCart(event, addToCartButton) {
    ...
    if (previousSibling) {
        ...
        if (product) {
            ...
            if (cartIcon) cartIcon.className = "fa-regular fa-circle-check";
        }
    } else console.error("Error: No se encontr\xf3 el elemento 'previousSibling'.");
}
...
//# sourceMappingURL=tienda.9ef8a79c.js.map
